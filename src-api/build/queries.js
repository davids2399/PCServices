...
class Queries {
    constructor() {
        ...
        this.computersWithFK = 'SELECT computers.id, companies.name as \'company\', computers.brand, computers.serial_number, computers.QR, computers.created_at FROM computers LEFT JOIN companies ON companies.id = computers.company_id';
...
exports.computersWithFK = new Queries().computersWithFK;
