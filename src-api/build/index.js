...
const computersRoutes_1 = __importDefault(require("./routes/computersRoutes"));
...
class Server {
    ...
    routes() {
        ...
        this.app.use('/api/companies', companiesRoutes_1.default);
        this.app.use('/api/computers', computersRoutes_1.default);
        this.app.use('/api/reports', reportsRoutes_1.default);
        this.app.use('/api/services', servicesRoutes_1.default);
